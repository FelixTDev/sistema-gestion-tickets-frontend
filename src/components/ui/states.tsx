...
export function AccessDeniedState() { return <div className="state state-error" role="alert"><strong>Acceso denegado</strong><span>Necesitas una sesión con el rol permitido para continuar.</span></div> }
